...
Response body matches `RaceRoomProjection` in `@crewcue/contracts` (includes **staleness / confidence** fields from WS2 Task 3 — see [ws2-task3-projection-staleness.md](./ws2-task3-projection-staleness.md)).
