...
- #479: fallback climb penalty 8 -> 3.6 s/m, plus a test pinning the magnitude.
- Coverage automation added micro-model simulation tests for mid-segment resume warm-up/clipping and live remaining-clock initial state handling.
