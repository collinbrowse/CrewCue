...
## Recent (2026-05-12): Race start anchor, projection bootstrap, map sheet (issue [#247](https://github.com/collinbrowse/CrewCue/issues/247))
...
- **Open:** [#247](https://github.com/collinbrowse/CrewCue/issues/247) — race anchor, projection bootstrap, map sheet (PR pending merge).
