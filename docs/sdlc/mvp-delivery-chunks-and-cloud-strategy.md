...
| ------------------------------ | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **D1 — WS2 depth**             | Baselines, weather stub or integration, richer course model, checkpoint stoppage time | Store inputs in Postgres; cache if needed — baseline slice: [chunk-d-d1-ws2-projection.md](./chunk-d-d1-ws2-projection.md) · stoppage spec: [chunk-d-d1-checkpoint-stoppage-time.md](./chunk-d-d1-checkpoint-stoppage-time.md) · stoppage API shipped in [#112](https://github.com/collinbrowse/CrewCue/pull/112) · staging smoke script: [chunk-d-d1-stoppage-time-staging-smoke.md](./chunk-d-d1-stoppage-time-staging-smoke.md) · follow-ups [#113](https://github.com/collinbrowse/CrewCue/issues/113) and [#114](https://github.com/collinbrowse/CrewCue/issues/114) are complete · next resilience gap closure [#162](https://github.com/collinbrowse/CrewCue/issues/162) |
...
| Date       | Change                                                                                                                                              |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-27 | Synced D1 timeline status: marked #113 and #114 complete and linked current resilience follow-up issue #162.                                       |
